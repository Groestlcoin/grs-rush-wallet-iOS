! function(e) {
    "object" == typeof exports ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : "undefined" != typeof window ? window.Bitcoin = e() : "undefined" != typeof global ? global.Bitcoin = e() : "undefined" != typeof self && (self.Bitcoin = e())
}(function() {
    ...
    return function e(t, n, r) {
        ...
        1: [function(require, module, exports) {
            ...
            var Address = function(bytes, version) {
                ...
                if (arguments[0] instanceof Address) {
                    ...
                    this.hash = bytes.length <= 34 ? base58.checkDecode(bytes) : bytes.length <= 40 ? conv.hexToBytes(bytes) : util.error("Bad input");
        ...
        2: [function(require, module, exports) {
            ...
            module.exports.checkEncode = function(input, vbyte) {
                ...
                var checksum = hexToBytes(Module.ccall('GroestlCoinHash', 'string', ['string'], [bytesToHex(front)])).slice(0, 4);
        ...
        3: [function(require, module, exports) {
            ...
            var PRIVDERIV = BIP32key.PRIVDERIV = "­ä";
            var PUBDERIV = BIP32key.PUBDERIV = "²";
            BIP32key.prototype.deserialize = function(str) {
                var bytes = base58.decode(str);
                var front = bytes.slice(0, bytes.length - 4),
                    back = bytes.slice(bytes.length - 4);
                var checksum = conv.hexToBytes(Module.ccall('GroestlCoinHash', 'string', ['string'], [conv.bytesToHex(front)])).slice(0, 4);
            ...
            BIP32key.prototype.serialize = function() {
                var bytes = this.vbytes.concat([this.depth], this.fingerprint, util.numToBytes(this.i, 4).reverse(), this.chaincode, this.type == "priv" ? [0].concat(this.key.export("bytes").slice(0, 32)) : this.key);
                var checksum = conv.hexToBytes(Module.ccall('GroestlCoinHash', 'string', ['string'], [conv.bytesToHex(bytes)])).slice(0, 4);
            ...
            BIP32key.prototype.ckd = function(i) {
                ...
                I = Crypto.HMAC(Crypto.SHA512, blob, this.chaincode, {
                    asBytes: true
                });
                if (this.type == "priv") {
                    ...
                    newkey = ECPointFp.decodeFrom(ecparams.getCurve(), this.key).add(new key(I.slice(0, 32).concat([1])).getPubPoint()).getEncoded(true);
            ...
            BIP32key.prototype.fromMasterKey = function(seed) {
                var I = Bitcoin.Crypto.HMAC(Bitcoin.Crypto.SHA512, seed, "Bitcoin seed", {
                    asBytes: true
                });
                return new BIP32key({
            ...
            BIP32key.prototype.getKey = function() {
                return this.key
            };
        ...
        4: [function(require, module, exports) {
            ...
            module.exports.bytesToBase64 = function(bytes) {
                for (var base64 = [], i = 0; i < bytes.length; i += 3) {
                    ...
                    for (var j = 0; j < 4; j++) {
                        if (i * 8 + j * 6 <= bytes.length * 8) base64.push(base64map.charAt(triplet >>> 6 * (3 - j) & 63));
                        else base64.push("=")
                    }
                }
                return base64.join("")
        ...
        6: [function(require, module, exports) {
            ...
            module.exports = function(hasher, message, key, options) {
                ...
                if (key.length > hasher._blocksize) key = hasher(key, {
                    asBytes: true
                });
                ...
                return options && options.asBytes ? hmacbytes : options && options.asString ? conv.bytesToString(hmacbytes) : conv.bytesToHex(hmacbytes)
            }
        }, {
            "../convert": 4,
            "../util": 22
        ...
        7: [function(require, module, exports) {
            ...
            module.exports = function(message, options) {
                ...
                return options && options.asBytes ? digestbytes : options && options.asString ? Binary.bytesToString(digestbytes) : conv.bytesToHex(digestbytes)
            }
        }, {
            "../convert": 4,
            "./crypto": 5
        ...
        11: [function(require, module, exports) {
            ...
            ECKey.prototype.export = function(format) {
                ...
                return format === "base58" ? base58.checkEncode(bytes, 128) : format === "bin" ? conv.bytesToString(bytes) : format === "bytes" ? bytes : format === "hex" ? conv.bytesToHex(bytes) : bytes
            };
            ...
            ECPointFp.decodeFrom = function(ecparams, enc) {
                ...
                if (type == 4) {
                    ...
                    var xBa = enc.slice(1),
                        ...
                        pPlus1Over4 = p.add(new Bitcoin.BigInteger("1")).divide(new Bitcoin.BigInteger("4")),
        ...
        18: [function(require, module, exports) {
            ...
            var util = require("./util");
            var Message = {};
            Message.magicPrefix = "Groestlcoin Signed Message:\n";
        ...
        20: [function(require, module, exports) {
            ...
            Script.prototype.toScriptHash = function() {
                ...
                return outType == "Pubkey" ? this.chunks[2] : outType == "P2SH" ? util.sha256ripe160(this.buffer) : util.sha256ripe160(this.buffer)
            };
            ...
            Script.prototype.getInType = function() {
                if (this.chunks.length == 1 && util.isArray(this.chunks[0])) {
                    return "Pubkey"
                } else if (this.chunks.length == 2 && util.isArray(this.chunks[0]) && util.isArray(this.chunks[1])) {
                    return "Address"
        ...
        21: [function(require, module, exports) {
            ...
            Transaction.prototype.getTotalOutValue = function() {
                return this.outs.reduce(function(t, o) {
                    return t + o.value
                }, 0)
            };
            ...
            Transaction.prototype.calcImpact = function(wallet) {
                ...
                var valueIn = this.ins.filter(function(i) {
                    return wallet.hasHash(conv.bytesToHex(i.script.simpleInPubKeyHash())) && wallet.txIndex[i.outpoint.hash]
                }).reduce(function(t, i) {
            ...
            Transaction.prototype.validateSig = function(index, script, sig, pub) {
                ...
                return ECDSA.verify(hash, conv.coerceToBytes(sig), conv.coerceToBytes(pub))
            };
            var TransactionIn = function(data) {

                if (typeof data == "string") this.outpoint = {
                    hash: data.split(":")[0],
                    index: data.split(":")[1]
                };
                else if (data.outpoint) this.outpoint = data.outpoint;
                else this.outpoint = {
                    hash: data.hash,
                    index: data.index
                };
                if (data.scriptSig) this.script = Script.fromScriptSig(data.scriptSig);
            ...
            var TransactionOut = function(data) {
                this.script = data.script instanceof Script ? data.script.clone() : util.isArray(data.script) ? new Script(data.script) : typeof data.script == "string" ? new Script(conv.hexToBytes(data.script)) : data.scriptPubKey ? Script.fromScriptSig(data.scriptPubKey) : data.address ? Script.createOutputScript(data.address) : new Script;
                if (this.script.buffer.length > 0) this.address = this.script.toAddress();
                this.value = util.isArray(data.value) ? util.bytesToNum(data.value) : "string" == typeof data.value ? parseInt(data.value) : data.value instanceof BigInteger ? parseInt(data.value.toString()) : data.value
            };
        ...
        23: [function(require, module, exports) {
            ...
            var Wallet = function(seed) {
                ...
                this.processTx = function(tx, verified) {
                    ...
                    for (var i = 0; i < tx.ins.length; i++) {
                        ...
                        if (o) {
                            o.spend = txhash + ":" + i;
                            o.spendpending = true;
                            o.timestamp = (new Date).getTime() / 1e3
                        }
                    }
                };
                this.processOutput = function(o) {
                    if (!this.outputs[o.output] || this.outputs[o.output].pending) this.outputs[o.output] = o
                };
                this.processExistingOutputs = function() {
                    var t = (new Date).getTime() / 1e3;
                    for (var o in this.outputs) {
                        if (o.pending && t > o.timestamp + 1200) delete this.outputs[o];
                ...
                var peoInterval = setInterval(this.processExistingOutputs, 1e4);
                this.getUtxoToPay = function(value) {
                    ...
                    throw "Not enough money to send funds including transaction fee. Have: " + totalval / 1e8 + ", needed: " + value / 1e8
                };
                this.mkSend = function(to, value, fee) {
                    var utxo = this.getUtxoToPay(value + fee);
                    var sum = utxo.reduce(function(t, o) {
                            return t + o.value
                        }, 0),
                    ...
                    halfChangeOut = {
                        address: change,
                        value: Math.floor(remainder / 2)
                    };
                    var outs = remainder < 5430 ? [toOut] : remainder < 10860 ? [toOut, changeOut] : unspentOuts == 5 ? [toOut, changeOut] : [toOut, halfChangeOut, halfChangeOut];
                ...
                this.mkSendToOutputs = function(outputs, changeIndex, fee) {
                    var value = outputs.reduce(function(t, o) {
                            return t + o.value
                        }, 0),
                        utxo = this.getUtxoToPay(value + fee),
                        sum = utxo.reduce(function(t, p) {
                            return t + o.value
                        }, 0);
                ...
                this.getPrivateKey = function(index) {
                    if (typeof index == "string") return keys.filter(function(i, k) {
                        return addresses[i] == index
                    })[0];
